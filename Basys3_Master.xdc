...
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports topclk]
...
set_property PACKAGE_PIN V3 [get_ports {aluout[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {aluout[9]}]
set_property PACKAGE_PIN W3 [get_ports {aluout[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {aluout[10]}]
set_property PACKAGE_PIN U3 [get_ports {aluout[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {aluout[11]}]
set_property PACKAGE_PIN P3 [get_ports {aluout[12]}]
set_property IOSTANDARD LVCMOS33 [get_ports {aluout[12]}]
set_property PACKAGE_PIN N3 [get_ports {aluout[13]}]
set_property IOSTANDARD LVCMOS33 [get_ports {aluout[13]}]
set_property PACKAGE_PIN P1 [get_ports {aluout[14]}]
set_property IOSTANDARD LVCMOS33 [get_ports {aluout[14]}]
set_property PACKAGE_PIN L1 [get_ports {aluout[15]}]
